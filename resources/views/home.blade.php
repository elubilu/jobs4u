	...
	<div class="slider-area mt-5">
                    <div class="preview-2">
                        <div id="nivoslider" class="slides">	
                            <img src="images/slider/3a.jpg" alt="" title="#slider-1-caption1"/>
                            <img src="images/slider/2b.jpg" alt="" title="#slider-1-caption2"/>
                            <img src="images/slider/1a.jpg" alt="" title="#slider-1-caption3"/>
                        </div> 
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="text-center">
                                    <a href="/All-Jobs" class="button large-button">Browse all jobs</a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="fun-factor-area bg-1 text-center fix bg-opacity-blue-5 ptb-120" >
                    <div class="container">
                        <div class="row">
                            <div class="col-md-3 col-sm-3">
                                <div class="single-fun-factor" >
                                    <h3 class="pb-15 mb-23" style="color: white;">Jobs</h3>
                                    <h1><span class="counter" style="color: white;">1350</span></h1>
                                </div>
                            </div>
                            <div class="col-md-3 col-sm-3">
                                <div class="single-fun-factor">
                                    <h3 class="pb-15 mb-23" style="color: white;">Members</h3>
                                    <h1><span class="counter" style="color: white;">500</span></h1>
                                </div>
                            </div>
                            <div class="col-md-3 col-sm-3">
                                <div class="single-fun-factor">
                                    <h3 class="pb-15 mb-23" style="color: white;">Resume</h3>
                                    <h1><span class="counter" style="color: white;">700</span></h1>
                                </div>
                            </div>
                            <div class="col-md-3 col-sm-3">
                                <div class="single-fun-factor" >
                                    <h3 class="pb-15 mb-23" style="color: white;">Company</h3>
                                    <h1><span class="counter" style="color: white;">1250</span></h1>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-md-6 col-xs-12">
                                <div class="advertise-content pl-15">
                                    ...
                                    Companies That Rely on Jobs4U</h3>
