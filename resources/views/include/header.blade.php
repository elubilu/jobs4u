...
<html class="no-js" lang="en">
    ...
    <body style="width: 100%;">
            ...
            <div class="as-mainwrapper" style="width: 100%;">
            <!--Bg White Start-->
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-md-3 col-xs-12">
                                <div class="logo"><a href="#"><img src="images/logo/7.png" alt="Jobs4U"></a></div>
                            </div>
                                ...
                                <div class="pull-right">
                                    <nav id="primary-menu">
                                        <ul class="main-menu text-right">
                                            ...
                                            <li><a href="/All-Jobs" target="_blank">Job Board</a>
                                            </li>
                                    ...
                                    <div class="login-btn pt-36">
                                      ...
                                      <div class="login-btn pt-36">
                                        <a class="modal-view button" href="/Signup">SignUp</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12">
                                    <div class="mobile-menu">
                                        <nav id="dropdown">
                                            <ul>
                                                <li><a href="/">HOME</a></li>
                                                <li><a href="/All-Jobs">Job Board</a> </li>
                        ...
                        <div class="row">
                            <div class="col-md-6 fix col-xs-12 col-sm-6">
                                <div class="footer-logo pull-left">
                                    <a href="#" class="block"><img src="images/logo/foter.png" alt=""></a>
                                </div>
                            </div>
                            <div class="col-md-6 fix col-xs-12 col-sm-6">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 col-sm-4">
                                <div class="single-footer-widget">
                                    ...
                                    <span class="text-white mb-9"><i class="fa fa-phone"></i>+88 017 480 84106</span>
                                    <span class="text-white mb-9"><i class="fa fa-envelope"></i>raselahmed.lucse@gmail.com</span>
                                    <span class="text-white mb-9"><i class="fa fa-globe"></i>www.raselahmed.co.nf</span>
                                    <span class="text-white mb-9"><i class="fa fa-map-marker"></i>Modina Matrket,Sylhet.</span>
                                </div>
                            </div>
                            <div class="col-md-3 col-sm-4">
                                <div class="single-footer-widget">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="footer-text">
                                    <span class="text-white block">Copyright&copy; <span>JOBS4U</span> 2019.All right reserved. Developed by <a href="http://raselahmed.co.nf/" class="text-white">Rasel Ahmed</a></span>
                                </div>
                            </div>
                        </div>
                    </div>
