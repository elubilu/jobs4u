                            ...
                            <div class="col-md-8 col-md-offset-2">
                                <form action="#">
                                    <div class="single-job-content">
                                        ...
                                        <div class="title uppercase pt-47 pb-26">
                                        	<span class="medium">Experience</span></div>
	                                        <div class="single-job-form">
	                                            <p>4 Year(s)</p>
	                                        </div>
                                        <div class="mt-38">
